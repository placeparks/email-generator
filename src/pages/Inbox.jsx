...
import { RefreshCw, Search, Mail, Clock, ChevronLeft, Trash2, Star, MoreHorizontal, Archive } from 'lucide-react';
...
const Inbox = () => {
    ...
    const fetchEmails = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${API_BASE_URL}/api/emails/inbox`, {
                    ...
                    <AnimatePresence>
                        {filteredEmails.map((email) => (
                            ...
                            >
                                ...
                                <h3 className={`text-sm mb-1.5 truncate ${email.isRead ? 'text-gray-500' : 'text-gray-200 font-semibold'}`}>
                                    {email.subject}
                                </h3>
            ...
            <div className={`${selectedEmail ? 'flex' : 'hidden lg:flex'} flex-1 flex-col bg-[#0f172a]/50`}>
                {selectedEmail ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-gray-500 bg-white/[0.02]">
                        ...
                        <p className="text-base font-medium text-gray-400">Select an email to read</p>
